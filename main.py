...
parser.add_argument('--img_height', dest='img_height', type=int, default=32, help='image height')
parser.add_argument('--img_width', dest='img_width', type=int, default=32, help='image width')
