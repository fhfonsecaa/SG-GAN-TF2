...
parser.add_argument('--img_height', dest='image_height', type=int, default=128, help='image height')
parser.add_argument('--img_width', dest='image_width', type=int, default=128, help='image width')
parser.add_argument('--ratio_gan2seg', dest='ratio_gan2seg', type=int, default=10, help='ratio of gan loss to seg loss')
parser.add_argument('--use_augmentation', dest='use_augmentation', type=bool, default=False, help='Enable/Disable Data Augmentation')
...
parser.add_argument('--use_pix2pix', dest='use_pix2pix', type=bool, default=True, help='pix2pix generator and discriminator')
